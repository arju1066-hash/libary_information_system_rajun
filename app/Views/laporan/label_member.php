...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Daftar Member — Pilih untuk Cetak Label</h3>
    ...
    <div class="card-body table-responsive">
        <table id="tabelLabelMember" class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th width="50">No.</th>
                    <th>Kode Member</th>
            ...
            <tbody>
                ...
                <?php foreach($members as $member): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('/laporan/cetak-label-member/' . $member['id_member']) ?>"
                               target="_blank"
